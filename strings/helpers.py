...
<b><u>Tᴀɢ-Aʟʟ :</b></u>
 ...
 /shayari ᴏʀ @sari ᴛᴏ ᴍᴇɴᴛɪᴏɴ ᴀʟʟ ᴍᴇᴍʙᴇʀs ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ, ᴡɪᴛʜ ʀᴀɴᴅᴏᴍ ꜱᴀʏᴀʀɪ.
 ꜰᴏʀ ꜱᴛᴏᴘ ᴛᴏ ᴜꜱᴇ /no
 /tagall ᴏʀ @all '(ʀᴇᴘʟʏ ᴛᴏ ᴍᴇssᴀɢᴇ ᴏʀ ᴀᴅᴅ ᴀɴᴏᴛʜᴇʀ ᴍᴇssᴀɢᴇ) ᴛᴏ ᴍᴇɴᴛɪᴏɴ ᴀʟʟ ᴍᴇᴍʙᴇʀs ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ, ᴡɪᴛʜᴏᴜᴛ ᴇxᴄᴇᴘᴛɪᴏɴ.ꜰᴏʀ ꜱᴛᴏᴘ ᴛᴏ ᴜꜱᴇ /cancel
 """
...
⦿ /bin ➠ ʙɪɴ ꜰᴜʟʟ ᴅᴇᴛᴀɪʟꜱ
⦿ /rmbg ➠ ᴘʜᴏᴛᴏ ᴛᴏ ʀᴇᴍᴏᴠᴇ ɪᴛ'ꜱ ʙᴀᴄᴋɢʀᴏᴜᴅ
"""
HELP_22 = """
<b><u>Iᴍᴀɢᴇ :</b></u>
