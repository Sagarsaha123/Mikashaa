...
def welcomepic(pic, user, chat, id, uname):
    background = Image.open("MikashaaAi/assets/bg2.jpg")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp)
    pfp = pfp.resize((450, 450))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('MikashaaAi/assets/font.ttf', size=40)
    welcome_font = ImageFont.truetype('MikashaaAi/assets/font.ttf', size=60)
