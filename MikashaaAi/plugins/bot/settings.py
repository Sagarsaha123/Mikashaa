...
from MikashaaAi.utils.decorators.admins import ActualAdminCB
from MikashaaAi.utils.decorators.language import language, languageCB
from MikashaaAi.utils.inline.settings import (
    auth_users_markup,
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaVideo("https://telegra.ph/file/e21c3132f4d95da91dba9.mp4"),
