...
BOT_TOKEN = getenv("BOT_TOKEN","6452346857:AAGNE7lofjABuRYluKcMoeyE0SZob7hfqMI")
...
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME","mikasha")
DEEP_API = getenv("DEEP_API","c8e3d7fc-1f7e-455b-8019-5c1b7f21047a")
OPENAI_KEY = getenv("OPENAI_KEY",None)
HEROKU_API_KEY = getenv("HEROKU_API_KEY","873d2c76-2cdf-4836-972a-5e311373dbe9")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/AMOPBOT/Mikashaa_AI",)
...
STRING1 = getenv("STRING_SESSION", "BACRtx4aTpwoU9SQp5aBJ1NufTdsm75KBrtCrORq3i_Og3A-o6VPGuFw0JFvt1jWhExf1tPaMjRlnVoNwwPEQ8cVIpJ5oqKMUyY8S06K9Kw-L8V6MlcQU8ytzNqkoYXCgkyy_G7vRhcQ90NGuRuKQzspPxmRukzn8kg2dp-o9yZuStcujwp3RGBS0CS-mF7-s3BCxPuGrtKF0LWAO9tF6AkzxQxepJ26Eihgq2AVnLlAONu8GZoWU67eDMsfEVBLe6RkpjixioONUtkpEnAT_BFMSFkOoUJxv5MZe9dAVo_d0AbAL9-X_fiiqVNrmfmKw9UHU8K5QSy5HyFggwrUtzg3AAAAAZYb1hkA")
